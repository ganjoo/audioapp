...
public final class OcrCaptureActivity extends AppCompatActivity implements Detector.Processor<TextBlock> {
    ...
    public void receiveDetections(Detector.Detections<TextBlock> detections) {
        ...
        for (int i = 0; i < items.size(); ++i) {
           ...
           // mGraphicOverlay.add(graphic);
            ...
            String animal_description = Utils.getTextFromOCRTag(animal_name, this);
            if(animal_description.length() > 0) {

                Intent intent = new Intent(OcrCaptureActivity.this.getApplicationContext(), DisplaySignageInfo.class);
                Bundle b = new Bundle();
                b.putString("animal_description", animal_description);
                intent.putExtras(b);
    ...
    public void onCreate(Bundle icicle) {
        ...
        mGraphicOverlay = (GraphicOverlay2<OcrGraphic>) findViewById(R.id.graphicOverlay);
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
       ...
       // textRecognizer.setProcessor(new OcrDetectorProcessor(mGraphicOverlay));
        ...
        mCameraSource =
                new CameraSource2.Builder(getApplicationContext(), textRecognizer)
