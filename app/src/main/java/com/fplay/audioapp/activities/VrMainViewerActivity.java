...
/**
 * Created by sonal on 22/08/17.
 */

public class VrMainViewerActivity extends VrAppcompatActivityTrackable {
...
//        setContentView(R.audio_animal_popup.activity_feeds);
//
...
//        Log.i("", this.hashCode() + ".onNewIntent()");
...
//            Toast.makeText(
//                    this, "Error loading video: " + errorMessage, Toast.LENGTH_LONG)
//                    .show();
