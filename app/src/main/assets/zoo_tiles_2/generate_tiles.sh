...
sudo mkdir $tilesfolder/$basename/2000
...
sudo $imagemagick $filename -resize 200%%  $basename-2000.$extension
...
sudo $imagemagick $basename.$extension -crop $tilesize'x'$tilesize -set filename:tile "%[fx:page.x/$tilesize]_%[fx:page.y/$tilesize]" +repage +adjoin "$tilesfolder/$basename/1000/%[filename:tile].$extension"
sudo $imagemagick $basename-2000.$extension -crop $tilesize'x'$tilesize -set filename:tile "%[fx:page.x/$tilesize]_%[fx:page.y/$tilesize]" +repage +adjoin "$tilesfolder/$basename/2000/%[filename:tile].$extension"
...
echo cleanup
sudo rm $basename-2000.$extension
